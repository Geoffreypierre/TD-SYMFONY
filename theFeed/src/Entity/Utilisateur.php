...
#[UniqueEntity('adresseEmail', message: "E-mail déjà utilisée !")]
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\NotBlank]
    #[Assert\NotNull]
    #[Assert\Length(min: 4, max: 20, minMessage: 'Il faut au moins 4 caractères!', maxMessage: 'Il faut au maximum 20 caractères!')]
